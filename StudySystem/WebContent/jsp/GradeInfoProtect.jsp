<%-- 
    Document   : GradeInfoProtect
    Created on : 2018-12-19, 20:15:58
...
<html>
    <head>
        ...
        <script type="text/javascript" src="<%=basepath%>/jsp/js/GradeInfoProject.js"></script>

        <title>班级信息维护</title>
    </head>
    <body>
        <input type="hidden" name="basePath" value="${basepath}"/>
        <div id="header_bar">班&nbsp;级&nbsp;信&nbsp;息&nbsp;维&nbsp;护</div>
        <div id="content">
            <!--            <div id="content_left">
            ...
            <form id="findStudent" action="${basepath}/grade/findGrade" method="post">
                <div id="content_right">
                    <div id="stuInfo">  
                        ...
                        <span id="search_button"><a href="${basepath}/jsp/GradeInfoAdd.jsp">添&nbsp;加</a></span>
                        </form>
                    </div>
                    <div id="stuInfoTable">
                        <table id="stuTableContent">
                            <tr id="tr_head">
                                <td class="col1" id="xuehao">班&nbsp;名</td>
                                <td class="col2" id="stuName">所属院系</td>
                                <td class="col3" id="stuSex">人&nbsp;数</td>
                                <td class="col4" id="stuOption">操&nbsp;作</td>
                            </tr>

                            <c:forEach items="${gras}" var="gra">
                                <tr>
                                    <td class="col1" id="xuehao">${gra.gradeName} </td><!--数据集-->
                                    <td class="col2" id="stuName">${gra.subject}</td>
                                    <td class="col3" id="stuSex">${gra.amount}</td>
                                    <td class="col4" id="stuOption">                                          
                                        <!--带参数，指定某一个，当前行的id-->
                                        <a href="${basepath}/grade/getGraById?id=${gra.id}" class="option" >修改</a>&nbsp;|&nbsp;
                                        <a class="option" href="${basepath}/grade/deleteGra?id=${gra.id}">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
